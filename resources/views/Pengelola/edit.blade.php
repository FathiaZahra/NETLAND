    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/dashboard/informasi/edit/simpan" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="isi_informasi" class="form-control" cols="20" rows="5">{{ $informasi->isi_informasi }}</textarea>
                                </div>
                                <div class="form-group">
